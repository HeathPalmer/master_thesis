...
class My_GA(GA):
    ...
    def initialize_population(self):
        ...
        self.population[0] = [-10, -1.5, 0,-1.5, 0, 1.5,0, 1.5, 10,-31.292, -2.235, 0,-0.447, 0, 0.447,0, 0.447, 3,-3, -1.5, 0,-1.5, 0, 1.5,0, 1.5, 3]
...
def create_pop():
    membershipFunction = []
    for x in range(3):
        outterBounds = [random.uniform(-10, 10), random.uniform(-10, 10)]
        outterBounds.sort()
    ...
    for x in range(3):
        outterBounds = [random.uniform(-31.292, 3), random.uniform(-31.292, 10)]
        outterBounds.sort()
        peak = random.uniform(outterBounds[0], outterBounds[1])
        membershipFunction.append(outterBounds[0])
        membershipFunction.append(peak)
    ...
    for x in range(3):
        outterBounds = [random.uniform(-5, 3), random.uniform(-5, 5.1)]
        outterBounds.sort()
        peak = random.uniform(outterBounds[0], outterBounds[1])
        membershipFunction.append(outterBounds[0])
        membershipFunction.append(peak)
...
def run(fis_start_time, end_time, chromosome_array_of_arrays):
    ...
    try:
        ...
        SUMOSECONDLONGITUDE = fuzzyLogic.createSecondFuzzyLongitudinalControl(chromosome_array_of_arrays)
...
if __name__ == "__main__":
    ...
    ga.chromosome_mutation_rate = 0.1  # Rate at which chromosomes get mutated
