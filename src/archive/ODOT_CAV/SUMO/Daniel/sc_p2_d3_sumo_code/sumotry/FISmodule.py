...
class FIS(object):
    ...
    def __init__(self,ni,nz,Ninmf,Noutmf,type_mf):
        ...
        self.nz = nz#number of outputs
        self.Ninmf=Ninmf#number of mem func
        self.Noutmf=Noutmf
        ...
        self.mins = []
        self.maxs = []
        # For the inputs append some membership functions
        for i in range(0, ni):
            self.u_in.append([])
            self.mf_in.append([])
    ...
    def eval_op(self,inputs):
        ...
        for k1 in unq_consq1:
            ...
            outs1.append(np.fmin(RF,self.tri_out[0][int(k1)]).tolist())#clipping
        ...
        #Implication steps#actually aggregation
